...
void page_level_render(uint8_t first_render)
{
	...
	char str_buf[10];
	oled_printf(2, 1, FONTID_6X8M, strcpy_P(str_buf, PSTR("”ровень")));
 	show_menu(2, 10);
...
static void show_level_bars(uint8_t x, uint8_t y)
{
	...
	oled_draw_line(x+13, y+4,  x+13, y+45); // лева€ лини€
	oled_draw_line(x+39, y+4,  x+39, y+45); // права€ лини€
	oled_draw_line(x+13, y+46, x+39, y+46); // нижн€€ лини€
